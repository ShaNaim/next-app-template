      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground mx-auto max-w-2xl text-xl">
            A comprehensive starter template with TypeScript, Tailwind CSS, shadcn/ui, and complete
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Beautiful, accessible, and customizable components</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="flex items-center space-x-2">
        ...
        <div className="space-y-4">
          <div className="text-center">
            <h2 className="text-3xl font-bold">OKLCH Color System</h2>
            <p className="text-muted-foreground">
              Beautiful, accessible colors that adapt perfectly to light and dark themes
            </p>
          </div>
        </div>
